...
def main(dataset_name="ton"):
    ...
    save_path = {
        "ton": cfg.ton_lstm_model_path,
        "sim": cfg.sim_lstm_model_path,
        "cic": cfg.cic_lstm_model_path,
    }[dataset_name.lower()]
    ...
    np.save(os.path.join(cfg.loss_dir, f"lstm_{dataset_name}_losses.npy"), np.array(train_losses))
